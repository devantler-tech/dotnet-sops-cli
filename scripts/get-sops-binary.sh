...
get "https://github.com/getsops/sops/releases/download/$version/sops-$version.exe" "sops.exe" "src/Devantler.SOPSCLI/runtimes/win-x64/native" "sops-win-x64.exe" false
